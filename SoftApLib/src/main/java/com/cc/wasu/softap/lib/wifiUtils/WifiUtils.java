...
import static com.cc.wasu.softap.lib.wifiUtils.ConnectorUtils.checkVersionAndGetIntent;
import static com.cc.wasu.softap.lib.wifiUtils.ConnectorUtils.cleanPreviousConfiguration;
import static com.cc.wasu.softap.lib.wifiUtils.ConnectorUtils.connectToWifi;
import static com.cc.wasu.softap.lib.wifiUtils.ConnectorUtils.connectToWifiHidden;
import static com.cc.wasu.softap.lib.wifiUtils.ConnectorUtils.connectWps;
import static com.cc.wasu.softap.lib.wifiUtils.ConnectorUtils.disconnectFromWifi;
import static com.cc.wasu.softap.lib.wifiUtils.ConnectorUtils.matchScanResult;
import static com.cc.wasu.softap.lib.wifiUtils.ConnectorUtils.matchScanResultBssid;
import static com.cc.wasu.softap.lib.wifiUtils.ConnectorUtils.matchScanResultSsid;
import static com.cc.wasu.softap.lib.wifiUtils.ConnectorUtils.reenableAllHotspots;
import static com.cc.wasu.softap.lib.wifiUtils.ConnectorUtils.registerReceiver;
import static com.cc.wasu.softap.lib.wifiUtils.ConnectorUtils.removeWifi;
import static com.cc.wasu.softap.lib.wifiUtils.ConnectorUtils.unregisterReceiver;
...
import static com.cc.wasu.softap.lib.wifiUtils.utils.VersionUtils.isLollipopOrLater;
...
import com.cc.wasu.softap.lib.wifiUtils.wifiConnect.DisconnectCallbackHolder;
import com.cc.wasu.softap.lib.wifiUtils.wifiConnect.TimeoutHandler;
import com.cc.wasu.softap.lib.wifiUtils.wifiConnect.WifiConnectionCallback;
import com.cc.wasu.softap.lib.wifiUtils.wifiConnect.WifiConnectionReceiver;
import com.cc.wasu.softap.lib.wifiUtils.wifiDisconnect.DisconnectionErrorCode;
import com.cc.wasu.softap.lib.wifiUtils.wifiDisconnect.DisconnectionSuccessListener;
import com.cc.wasu.softap.lib.wifiUtils.wifiRemove.RemoveErrorCode;
...
import com.cc.wasu.softap.lib.wifiUtils.wifiScan.WifiScanCallback;
import com.cc.wasu.softap.lib.wifiUtils.wifiScan.WifiScanReceiver;
import com.cc.wasu.softap.lib.wifiUtils.wifiState.WifiStateCallback;
import com.cc.wasu.softap.lib.wifiUtils.wifiState.WifiStateListener;
import com.cc.wasu.softap.lib.wifiUtils.wifiState.WifiStateReceiver;
...
public final class WifiUtils implements WifiConnectorBuilder,
    ...
    private final WifiConnectionCallback mWifiConnectionCallback = new WifiConnectionCallback() {
        ...
        public void onDisconnect() {
            of(mConnectionSuccessListener).ifPresent(successListener -> {
                successListener.failed(ConnectionErrorCode.DISCONNECT);
            });
        }
    };
