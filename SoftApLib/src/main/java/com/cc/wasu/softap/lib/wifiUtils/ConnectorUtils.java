...
import static com.cc.wasu.softap.lib.wifiUtils.utils.SSIDUtils.convertToQuotedString;
import static com.cc.wasu.softap.lib.wifiUtils.utils.VersionUtils.isAndroidQOrLater;
import static com.cc.wasu.softap.lib.wifiUtils.utils.VersionUtils.isJellyBeanOrLater;
import static com.cc.wasu.softap.lib.wifiUtils.utils.VersionUtils.isLollipopOrLater;
import static com.cc.wasu.softap.lib.wifiUtils.utils.VersionUtils.isMarshmallowOrLater;
...
import com.cc.wasu.softap.lib.wifiUtils.utils.VersionUtils;
...
//                .addCapability(NetworkCapabilities.NET_CAPABILITY_INTERNET)
        ...
        final ConnectivityManager.NetworkCallback networkCallback = new ConnectivityManager.NetworkCallback() {
            ...
            public void onLost(@NonNull Network network) {
                ...
                DisconnectCallbackHolder.getInstance().disconnect();
                wifiConnectionCallback.onDisconnect();
            }
        };
